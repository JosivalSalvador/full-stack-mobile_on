"""Provider local: avalia a força de uma senha sem que ela saia do
processo.
...
class LocalPasswordModel(Provider[str, PasswordStrengthResult]):
    """Provider que roda `zxcvbn` localmente sobre uma senha."""
